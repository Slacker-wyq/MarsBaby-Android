...
public class AddRecordActivity extends ActivityBase {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.register_submit_bt:
                ...
                RequestParams params = new RequestParams(MyApplication.BASE_URL + "AddRecord");
                params.addQueryStringParameter("bid", bid+ "");
